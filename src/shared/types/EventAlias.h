...
using ButtonEvent                   = EventView<EventType::Button>;
using ButtonRepeatEvent             = EventView<EventType::ButtonRepeat>;
using EncoderStepEvent              = EventView<EventType::EncoderStep>;
using RequestFanModeEvent           = EventView<EventType::RequestFanMode>;
using RequestFermentationModeEvent  = EventView<EventType::RequestFermentationMode>;
using RequestTargetTemperatureEvent = EventView<EventType::RequestTargetTemperature>;
...
using ButtonPayload                   = EventPayload<EventType::Button>;
using ButtonRepeatPayload             = EventPayload<EventType::ButtonRepeat>;
using EncoderStepPayload              = EventPayload<EventType::EncoderStep>;
using RequestFanModePayload           = EventPayload<EventType::RequestFanMode>;
using RequestFermentationModePayload  = EventPayload<EventType::RequestFermentationMode>;
using RequestTargetTemperaturePayload = EventPayload<EventType::RequestTargetTemperature>;
