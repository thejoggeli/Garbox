...
void SimpleScreenGui::init(){
    ...
    mObjects.fermentationStatus.body.setBgOpa(255);                             // bg-opa="100%"
    ...
    mObjects.measuredTemperature.body.setBgColor(lv_color_hex(0x8ab4f4));       // bg-color="#8AB4F4"
    mObjects.measuredTemperature.body.setBgOpa(255);                            // bg-opa="100%"
    ...
    mObjects.measuredHumidity.body.setBgOpa(255);                               // bg-opa="100%"
    ...
    mObjects.heaterPower.body.setBgOpa(255);                                    // bg-opa="100%"
