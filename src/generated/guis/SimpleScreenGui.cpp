...
void SimpleScreenGui::init(){
    ...
    mObjects.infoTiles.setPad(0, 4, 4, 4);                                      // pad="0 4px 4px 4px"
    mObjects.infoTiles.setPadGap(4);                                            // pad-gap="4px"
    ...
    mObjects.fermentationStatus.body.setBorderColor(lv_color_hex(0x666666));    // border-color="#666"
    mObjects.fermentationStatus.body.setBorderOpa(255);                         // border-opa="100%"
    mObjects.fermentationStatus.body.setBorderWidth(1);                         // border-width="1px"
    mObjects.fermentationStatus.body.setBorderSide(LV_BORDER_SIDE_FULL);        // border-side="full"
    mObjects.fermentationStatus.body.setBgColor(lv_color_hex(0x666666));        // bg-color="#666"
    ...
    mObjects.fermentationStatus.body.setRadius(4);                              // radius="4px"
    ...
    mObjects.measuredTemperature.body.setBorderColor(lv_color_hex(0x666666));   // border-color="#666"
    mObjects.measuredTemperature.body.setBorderOpa(255);                        // border-opa="100%"
    mObjects.measuredTemperature.body.setBorderWidth(1);                        // border-width="1px"
    mObjects.measuredTemperature.body.setBorderSide(LV_BORDER_SIDE_FULL);       // border-side="full"
    mObjects.measuredTemperature.body.setBgColor(lv_color_hex(0x666666));       // bg-color="#666"
    ...
    mObjects.measuredTemperature.body.setRadius(4);                             // radius="4px"
    ...
    mObjects.measuredHumidity.body.setBorderColor(lv_color_hex(0x666666));      // border-color="#666"
    mObjects.measuredHumidity.body.setBorderOpa(255);                           // border-opa="100%"
    mObjects.measuredHumidity.body.setBorderWidth(1);                           // border-width="1px"
    mObjects.measuredHumidity.body.setBorderSide(LV_BORDER_SIDE_FULL);          // border-side="full"
    ...
    mObjects.measuredHumidity.body.setRadius(4);                                // radius="4px"
    ...
    mObjects.heaterPower.body.setBorderColor(lv_color_hex(0x666666));           // border-color="#666"
    mObjects.heaterPower.body.setBorderOpa(255);                                // border-opa="100%"
    mObjects.heaterPower.body.setBorderWidth(1);                                // border-width="1px"
    mObjects.heaterPower.body.setBorderSide(LV_BORDER_SIDE_FULL);               // border-side="full"
    ...
    mObjects.heaterPower.body.setRadius(4);                                     // radius="4px"
