...
void SimpleScreenGui::init(){
    ...
    mObjects.arcMeasured.setArcRange(15, 50);                                   // arc-range="15 50"
    mObjects.arcMeasured.setArcValue(25);                                       // arc-value="25"
    ...
    mObjects.arcTarget.setArcRange(15, 50);                                     // arc-range="15 50"
    mObjects.arcTarget.setArcValue(35);                                         // arc-value="35"
