...
public:
    ...
    MainScreenStates(const MainScreenStates&) = delete;
    MainScreenStates& operator=(const MainScreenStates&) = delete;
    MainScreenStates(MainScreenStates&&) = delete;
    MainScreenStates& operator=(MainScreenStates&&) = delete;
