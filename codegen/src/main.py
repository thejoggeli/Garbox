...
def main():
    ...
    application_config = load_application_config(ctx.config_dir)
    generate_components(ctx, application_config)

    # runtime generation
    generate_runtime(ctx, application_config, events_config)
